...
#'   of "housekeeping" (HK) genes from the cDNA microarray analysis of Eisenberg
...
#'   lines."
#'
#' @details Human gene symbols in \code{housekeeping_revised} are from Eisenberg
...
#'   value differed from the averaged log2(RPKM) by two (fourfold) or more." "We
#'   define a housekeeping gene as a gene for which at least one RefSeq
