...
subsampled_scone = subsample_scone(my_scone, subsample_gene_level = 75,
                                   subsample_cell_level = 50, at_bio = FALSE,
                                   keep_all_control = TRUE)

```

Now let's run the scone report on the new subsampled scone object.
...
# Shiny app
sconeReport(subsampled_scone,methods = scone_methods,
            qc = ppq,
            bio = bio,
